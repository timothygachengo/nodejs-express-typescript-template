...
export class NotFoundMsgResponse<T> extends ApiResponse {
    constructor(message:string, private data : T){
        super(StatusCode.FAILURE, ResponseStatus.NOT_FOUND, message);
    }

    override send(res: Response): Response {
        return super.prepare<NotFoundMsgResponse<T>>(res, this);
    }
}
...
export class BadRequestMsgResponse<T> extends ApiResponse {
    constructor(message: string, private data: T) {
        super(StatusCode.FAILURE, ResponseStatus.BAD_REQUEST, message);
    }

    override send(res: Response): Response {
        return super.prepare<BadRequestMsgResponse<T>>(res, this);
    }
}
